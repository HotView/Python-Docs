...
ISBN: 0132354187
    ...
    The examples in this archive use Python 3/PyQt 4.5.1.
    (Note that PyQt 4.5.0 is insufficient for the examples that use
    Qt Designer .ui files.)
    Some of the examples include small improvements and all of them
    import the PyQt libraries using the form "from PyQt4.QtCore import
    (Qt, SIGNAL)" etc.---i.e., importing each item by name---rather than
    the "from PyQt4.QtCore import *" form used in the book's examples.

    These examples are straight conversions of the book's original
    examples---so they do not take any advantage of the new more
    Pythonic APIs offered by PyQt 4.5, nor of the new features offered
    by Qt 4.4 and Qt 4.5; all that will have to wait for a future
    edition.
